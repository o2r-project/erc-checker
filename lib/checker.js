			...
			if (images.length == 0) {
				...
				images.forEach(
					function (current, index) {
						...
						var numberMismatchedPixels = pixelmatch(img1.data, img1.data, diff2.data, img1.width, img1.height, { threshold: 0.1 });
						console.log(numberMismatchedPixels);

						// pixelmatch(img3.data, img3.data, diff2.data, img1.width, img1.height, { alpha: 0.5, threshold: 0.1, diffColor: [255, 0, 0], aaColor: [255, 255, 0], includeAA: true, diffMask: true });

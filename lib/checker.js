			...
			twoDimensionalArrayOfBuffers.forEach(
				function (current, index) {
					...
					if (current[0] === current[1]) {
						resultingImageBuffers.images[index] = equalBuffers(current[0], current[1]);
					}
					...
					resizeImageIfNecessary(current[0], current[1], dimensionsOriginal, dimensionsReproduced, index)

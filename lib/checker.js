			...
			try {
				...
				*/
				if (bufferedImagesOriginal.length < bufferedImagesReproduced.length) {
					reject(new Error("There are more reproduced images than original images (" + bufferedImagesOriginal.length + " originalImageBuffers and " + bufferedImagesReproduced.length + " reproducedImageBuffers)."));
				}
